...
const arg_def_t *av1_key_val_args[] = {
  ...
  &g_av1_codec_arg_defs.enable_new_tx_partition_4way,
#endif
#if CONFIG_IST
...
#endif
#if CONFIG_NEW_TX_PARTITION
  config->enable_new_tx_partition_4way = 1;
#endif
#if CONFIG_IST
  config->enable_ist = 1;
#endif
...
#endif
#if CONFIG_NEW_TX_PARTITION
  fprintf(stdout, "                               : NTP_4way_split (%d)\n",
          encoder_cfg->enable_new_tx_partition_4way);
#endif
  fprintf(stdout,
