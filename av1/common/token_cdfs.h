...
static const aom_cdf_prob av1_default_coeff_lps_multi_cdfs[TOKEN_CDF_Q_CTXS][PLANE_TYPES][LEVEL_CONTEXTS][CDF_SIZE(BR_CDF_SIZE)] = {
  {
    {
...
static const aom_cdf_prob av1_default_coeff_base_lf_eob_multi_cdfs[TOKEN_CDF_Q_CTXS][TX_SIZES][PLANE_TYPES][SIG_COEF_CONTEXTS_EOB][CDF_SIZE(LF_BASE_SYMBOLS - 1)] = {
  {
    {
      {
...
static const aom_cdf_prob av1_default_coeff_lps_lf_multi_cdfs[TOKEN_CDF_Q_CTXS][PLANE_TYPES][LF_LEVEL_CONTEXTS][CDF_SIZE(BR_CDF_SIZE)] = {
  {
    {
      { AOM_CDF4(15917, 18695, 21222) },
...
static const aom_cdf_prob av1_default_coeff_base_eob_multi_cdfs[TOKEN_CDF_Q_CTXS][TX_SIZES][PLANE_TYPES][SIG_COEF_CONTEXTS_EOB][CDF_SIZE(NUM_BASE_LEVELS + 1)] = {
  {
    {
      {
