...
static const aom_cdf_prob
    av1_default_v_dc_sign_cdfs[TOKEN_CDF_Q_CTXS][3][DC_SIGN_CONTEXTS]
                              [CDF_SIZE(2)] = {
                                { {
                                      { AOM_CDF2(128 * 125) },
                                      { AOM_CDF2(128 * 102) },
...
static const aom_cdf_prob av1_default_v_ac_sign_cdfs[TOKEN_CDF_Q_CTXS][3]
                                                    [CDF_SIZE(2)] = {
                                                      {
                                                          { AOM_CDF2(16384) },
                                                          { AOM_CDF2(16384) },
...
static const aom_cdf_prob
    av1_default_cr_txb_skip_cdfs[TOKEN_CDF_Q_CTXS][CR_TXB_SKIP_CONTEXTS]
                                [CDF_SIZE(2)] = { {
                                                      { AOM_CDF2(16384) },
                                                      { AOM_CDF2(16384) },
                                                      { AOM_CDF2(16384) },
