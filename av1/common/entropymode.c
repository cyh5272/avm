...
static const aom_cdf_prob
    default_fsc_mode_cdf[FSC_MODE_CONTEXTS][FSC_BSIZE_CONTEXTS]
                        [CDF_SIZE(FSC_MODES)] = { { { AOM_CDF2(27737) },
                                                    { AOM_CDF2(31685) },
                                                    { AOM_CDF2(32060) },
                                                    { AOM_CDF2(32471) },
                                                    { AOM_CDF2(32457) } },
...
static const aom_cdf_prob default_intra_ext_tx_cdf
    [EXT_TX_SETS_INTRA][EXT_TX_SIZES][INTRA_MODES][CDF_SIZE(TX_TYPES)] = {
      ...
      {
          {
              { AOM_CDF6(5691, 5695, 7828, 21255, 26749) },
              { AOM_CDF6(3161, 12254, 12260, 23723, 30357) },
              { AOM_CDF6(3156, 3161, 13363, 23737, 25668) },
              { AOM_CDF6(9595, 9606, 9610, 18645, 30215) },
              { AOM_CDF6(3633, 3637, 6855, 21371, 27155) },
              { AOM_CDF6(3786, 11723, 11727, 22656, 29497) },
              { AOM_CDF6(2271, 2275, 5219, 21169, 25823) },
              { AOM_CDF6(4405, 4409, 12439, 21459, 23343) },
              { AOM_CDF6(4467, 13038, 13042, 22325, 30841) },
              { AOM_CDF6(4504, 4508, 6190, 22218, 27302) },
              { AOM_CDF6(3762, 8074, 8078, 20558, 28466) },
              { AOM_CDF6(3768, 3772, 7805, 20209, 24440) },
              { AOM_CDF6(51, 6181, 11382, 23594, 28279) },
          },
          {
              { AOM_CDF6(9258, 9262, 9760, 20078, 26143) },
              { AOM_CDF6(9727, 14344, 14348, 23577, 29888) },
              { AOM_CDF6(10446, 10450, 15595, 24040, 26279) },
              { AOM_CDF6(18280, 18284, 18288, 27113, 31979) },
              { AOM_CDF6(13203, 13207, 13344, 28202, 30474) },
              { AOM_CDF6(13480, 15070, 15074, 28012, 30638) },
              { AOM_CDF6(6020, 6024, 6773, 21769, 26414) },
              { AOM_CDF6(14676, 14680, 16580, 24828, 26285) },
              { AOM_CDF6(15108, 17069, 17073, 26271, 31379) },
              { AOM_CDF6(12269, 12273, 12419, 27293, 29913) },
              { AOM_CDF6(9702, 10775, 10779, 22429, 29638) },
              { AOM_CDF6(10753, 10757, 11533, 21903, 25337) },
              { AOM_CDF6(120, 4779, 8875, 21498, 26866) },
          },
          {
      ...
      },
      {
          ...
          {
              { AOM_CDF4(7130, 19441, 26055) },
              { AOM_CDF4(11293, 21456, 29819) },
              { AOM_CDF4(13503, 23474, 25527) },
              { AOM_CDF4(19561, 26759, 32519) },
              { AOM_CDF4(13069, 30267, 31411) },
              { AOM_CDF4(11796, 28586, 30790) },
              { AOM_CDF4(4338, 24304, 27724) },
              { AOM_CDF4(15417, 23541, 24351) },
              { AOM_CDF4(16864, 25195, 32027) },
              { AOM_CDF4(11163, 26798, 29730) },
              { AOM_CDF4(8909, 21017, 30269) },
              { AOM_CDF4(12168, 23614, 25805) },
              { AOM_CDF4(2577, 20037, 25970) },
          },
          {
              { AOM_CDF4(8192, 16384, 24576) },
              { AOM_CDF4(8192, 16384, 24576) },
