...
static const aom_cdf_prob
    default_wedge_interintra_cdf[BLOCK_SIZES_ALL][CDF_SIZE(2)] = {
      { AOM_CDF2(16384) }, { AOM_CDF2(16384) }, { AOM_CDF2(16384) },
      { AOM_CDF2(13606) }, { AOM_CDF2(18193) }, { AOM_CDF2(18788) },
      { AOM_CDF2(20913) }, { AOM_CDF2(25000) }, { AOM_CDF2(25380) },
      { AOM_CDF2(25334) }, { AOM_CDF2(16384) }, { AOM_CDF2(16384) },
      { AOM_CDF2(16384) }, { AOM_CDF2(16384) }, { AOM_CDF2(16384) },
      { AOM_CDF2(16384) }, { AOM_CDF2(16384) }, { AOM_CDF2(16384) },
      { AOM_CDF2(16384) }, { AOM_CDF2(16384) }, { AOM_CDF2(16384) },
      { AOM_CDF2(16384) }
...
static const aom_cdf_prob default_wedge_category_cdf[BLOCK_SIZES_ALL][CDF_SIZE(
    2)] = { { AOM_CDF2(16384) }, { AOM_CDF2(16384) }, { AOM_CDF2(16384) },
            { AOM_CDF2(31175) }, { AOM_CDF2(26786) }, { AOM_CDF2(31141) },
            { AOM_CDF2(28941) }, { AOM_CDF2(18493) }, { AOM_CDF2(27552) },
            { AOM_CDF2(25091) }, { AOM_CDF2(16384) }, { AOM_CDF2(16384) },
            { AOM_CDF2(16384) }, { AOM_CDF2(16384) }, { AOM_CDF2(16384) },
            { AOM_CDF2(16384) }, { AOM_CDF2(16384) }, { AOM_CDF2(16384) },
            { AOM_CDF2(20004) }, { AOM_CDF2(27484) }, { AOM_CDF2(16384) },
            { AOM_CDF2(16384) } };
...
static const aom_cdf_prob
    default_wedge_idx_cdf[BLOCK_SIZES_ALL][CDF_SIZE(MAX_WEDGE_TYPES)] = {
      ...
      { AOM_CDF16(2048, 4096, 6144, 8192, 10240, 12288, 14336, 16384, 18432,
                  20480, 22528, 24576, 26624, 28672, 30720) },
      { AOM_CDF16(2280, 3332, 5168, 6771, 11498, 12064, 19465, 20730, 25238,
                  26807, 27067, 27498, 30597, 32093, 32257) },
      { AOM_CDF16(1221, 3637, 6525, 7539, 7647, 7759, 7956, 14477, 21545, 22270,
                  22507, 22895, 28689, 30906, 31989) },
      { AOM_CDF16(3197, 3343, 3668, 7188, 7288, 7446, 7644, 11687, 20614, 23087,
                  24210, 25273, 31685, 32382, 32456) },
      { AOM_CDF16(2323, 2836, 4300, 5842, 10581, 11609, 17704, 19454, 23874,
                  25400, 26137, 26837, 30756, 32076, 32418) },
      { AOM_CDF16(2254, 3361, 5302, 7175, 7722, 8031, 8698, 15244, 21501, 23232,
                  24573, 26040, 28477, 30242, 31586) },
      { AOM_CDF16(3807, 3994, 4326, 7402, 7763, 7900, 8388, 12842, 19416, 22477,
                  24503, 26725, 31043, 32262, 32530) },
      { AOM_CDF16(2601, 3046, 4371, 6206, 10781, 12759, 17669, 20032, 23604,
                  25156, 26629, 27729, 30678, 32197, 32560) },
      { AOM_CDF16(2048, 4096, 6144, 8192, 10240, 12288, 14336, 16384, 18432,
                  20480, 22528, 24576, 26624, 28672, 30720) },
      { AOM_CDF16(2048, 4096, 6144, 8192, 10240, 12288, 14336, 16384, 18432,
                  20480, 22528, 24576, 26624, 28672, 30720) },
      ...
      { AOM_CDF16(2048, 4096, 6144, 8192, 10240, 12288, 14336, 16384, 18432,
                  20480, 22528, 24576, 26624, 28672, 30720) },
      { AOM_CDF16(154, 227, 323, 403, 418, 424, 439, 24916, 25503, 25970, 26728,
                  27917, 29434, 31461, 32418) },
      { AOM_CDF16(899, 903, 910, 1939, 1946, 1950, 1954, 21209, 23157, 26136,
                  28888, 31219, 31910, 32565, 32652) },
      { AOM_CDF16(2048, 4096, 6144, 8192, 10240, 12288, 14336, 16384, 18432,
                  20480, 22528, 24576, 26624, 28672, 30720) },
      { AOM_CDF16(2048, 4096, 6144, 8192, 10240, 12288, 14336, 16384, 18432,
                  20480, 22528, 24576, 26624, 28672, 30720) }
...
static const aom_cdf_prob default_wedge_idx2_cdf[BLOCK_SIZES_ALL][CDF_SIZE(
    MAX_WEDGE_TYPES2)] = { { AOM_CDF6(5461, 10923, 16384, 21845, 27307) },
                           { AOM_CDF6(5461, 10923, 16384, 21845, 27307) },
                           { AOM_CDF6(5461, 10923, 16384, 21845, 27307) },
                           { AOM_CDF6(2434, 16908, 21118, 26131, 29943) },
                           { AOM_CDF6(4911, 9077, 25556, 28655, 30910) },
                           { AOM_CDF6(2588, 9668, 18096, 22945, 28025) },
                           { AOM_CDF6(5491, 13293, 19397, 24916, 29052) },
                           { AOM_CDF6(6684, 11462, 21727, 25730, 29084) },
                           { AOM_CDF6(3407, 9899, 17083, 21983, 27159) },
                           { AOM_CDF6(5171, 11884, 18223, 23729, 28482) },
                           { AOM_CDF6(5461, 10923, 16384, 21845, 27307) },
                           { AOM_CDF6(5461, 10923, 16384, 21845, 27307) },
                           { AOM_CDF6(5461, 10923, 16384, 21845, 27307) },
                           { AOM_CDF6(5461, 10923, 16384, 21845, 27307) },
                           ...
                           { AOM_CDF6(5461, 10923, 16384, 21845, 27307) },
                           { AOM_CDF6(5461, 10923, 16384, 21845, 27307) },
                           { AOM_CDF6(5565, 9504, 14338, 20262, 26472) },
                           { AOM_CDF6(1470, 5774, 9804, 12863, 22987) },
                           { AOM_CDF6(5461, 10923, 16384, 21845, 27307) },
                           { AOM_CDF6(5461, 10923, 16384, 21845, 27307) } };
