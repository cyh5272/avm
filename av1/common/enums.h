...
#define EXTREF_FRAMES (REF_FRAMES + 3)
#endif  // CONFIG_TIP

#define WEIGHTED_FRAME_0 (TIP_FRAME + 1)
#define WEIGHTED_REF_0_INDEX (TIP_FRAME_INDEX + 1)
#define WEIGHTED_FRAME_1 (TIP_FRAME + 2)
#define WEIGHTED_REF_1_INDEX (TIP_FRAME_INDEX + 2)
