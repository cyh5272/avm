...
MAKE_BFP_SAD_WRAPPER(aom_highbd_sad256x64)
MAKE_BFP_SADAVG_WRAPPER(aom_highbd_sad64x256_avg)
MAKE_BFP_SAD4D_WRAPPER(aom_highbd_sad256x64x4d)

MAKE_BFP_SADAVG_WRAPPER(aom_highbd_sad256x64_avg)
MAKE_BFP_SAD_WRAPPER(aom_highbd_sad64x256)
MAKE_BFP_SAD4D_WRAPPER(aom_highbd_sad64x256x4d)
...
#if CONFIG_BLOCK_256_EXT
MAKE_BFP_JSADAVG_WRAPPER(aom_highbd_dist_wtd_sad256x64_avg)
MAKE_BFP_JSADAVG_WRAPPER(aom_highbd_dist_wtd_sad64x256_avg)
MAKE_BFP_JSADAVG_WRAPPER(aom_highbd_dist_wtd_sad32x128_avg)
MAKE_BFP_JSADAVG_WRAPPER(aom_highbd_dist_wtd_sad128x32_avg)
#endif  // CONFIG_BLOCK_256_EXT
        //
#if CONFIG_FLEX_PARTITION
...
#if CONFIG_BLOCK_256_EXT
MAKE_MBFP_COMPOUND_SAD_WRAPPER(aom_highbd_masked_sad256x64)
MAKE_MBFP_COMPOUND_SAD_WRAPPER(aom_highbd_masked_sad64x256)
...
#if CONFIG_BLOCK_256_EXT
MAKE_SDSF_SKIP_SAD_WRAPPER(aom_highbd_sad_skip_256x64)
MAKE_SDSF_SKIP_SAD_WRAPPER(aom_highbd_sad_skip_64x256)
MAKE_SDSF_SKIP_SAD_WRAPPER(aom_highbd_sad_skip_32x128)
MAKE_SDSF_SKIP_SAD_WRAPPER(aom_highbd_sad_skip_128x32)
#endif  // CONFIG_BLOCK_256_EXT
#if CONFIG_FLEX_PARTITION
...
#if CONFIG_BLOCK_256_EXT
MAKE_SDSF_SKIP_SAD_4D_WRAPPER(aom_highbd_sad_skip_256x64x4d)
MAKE_SDSF_SKIP_SAD_4D_WRAPPER(aom_highbd_sad_skip_64x256x4d)
MAKE_SDSF_SKIP_SAD_4D_WRAPPER(aom_highbd_sad_skip_32x128x4d)
MAKE_SDSF_SKIP_SAD_4D_WRAPPER(aom_highbd_sad_skip_128x32x4d)
#endif  // CONFIG_BLOCK_256_EXT
#if CONFIG_FLEX_PARTITION
...
#if CONFIG_BLOCK_256_EXT
MAKE_OBFP_SAD_WRAPPER(aom_highbd_obmc_sad256x64)
MAKE_OBFP_SAD_WRAPPER(aom_highbd_obmc_sad64x256)
...
#if CONFIG_BLOCK_256_EXT
      HIGHBD_BFP_WRAPPER(64, 256, 8)
      HIGHBD_BFP_WRAPPER(256, 64, 8)
      HIGHBD_BFP_WRAPPER(128, 32, 8)
      HIGHBD_BFP_WRAPPER(32, 128, 8)

      HIGHBD_MBFP_WRAPPER(64, 256, 8)
      HIGHBD_MBFP_WRAPPER(256, 64, 8)
      HIGHBD_MBFP_WRAPPER(128, 32, 8)
      HIGHBD_MBFP_WRAPPER(32, 128, 8)
#endif  // CONFIG_BLOCK_256_EXT
#if CONFIG_FLEX_PARTITION
...
#if CONFIG_BLOCK_256_EXT
      LOWBD_OBFP_WRAPPER(256, 64)
      LOWBD_OBFP_WRAPPER(64, 256)
      LOWBD_OBFP_WRAPPER(32, 128)
      LOWBD_OBFP_WRAPPER(128, 32)
#endif  // CONFIG_BLOCK_128
#if CONFIG_FLEX_PARTITION
...
#if CONFIG_BLOCK_256_EXT
      HIGHBD_SDSFP_WRAPPER(256, 64, 8)
      HIGHBD_SDSFP_WRAPPER(64, 256, 8)
      HIGHBD_SDSFP_WRAPPER(32, 128, 8)
      HIGHBD_SDSFP_WRAPPER(128, 32, 8)
#endif  // CONFIG_BLOCK_256_EXT
#if CONFIG_FLEX_PARTITION
...
#endif  // CONFIG_FLEX_PARTITION
#if CONFIG_BLOCK_256_EXT
      HIGHBD_BFP_WRAPPER(64, 256, 10)
      HIGHBD_BFP_WRAPPER(256, 64, 10)
      HIGHBD_BFP_WRAPPER(128, 32, 10)
      HIGHBD_BFP_WRAPPER(32, 128, 10)
#endif  // CONFIG_BLOCK_256_EXT
#if CONFIG_BLOCK_256
...
#if CONFIG_BLOCK_256_EXT
      HIGHBD_MBFP_WRAPPER(256, 64, 10)
      HIGHBD_MBFP_WRAPPER(64, 256, 10)
      HIGHBD_MBFP_WRAPPER(32, 128, 10)
      HIGHBD_MBFP_WRAPPER(128, 32, 10)
#endif  // CONFIG_BLOCK_256_EXT
#if CONFIG_FLEX_PARTITION
...
#if CONFIG_BLOCK_256_EXT
      HIGHBD_OBFP_WRAPPER(256, 64, 10)
      HIGHBD_OBFP_WRAPPER(64, 256, 10)
      HIGHBD_OBFP_WRAPPER(32, 128, 10)
      HIGHBD_OBFP_WRAPPER(128, 32, 10)
#endif  // CONFIG_BLOCK_256_EXT
#if CONFIG_FLEX_PARTITION
...
#if CONFIG_BLOCK_256_EXT
      HIGHBD_SDSFP_WRAPPER(256, 64, 10)
      HIGHBD_SDSFP_WRAPPER(64, 256, 10)
      HIGHBD_SDSFP_WRAPPER(32, 128, 10)
      HIGHBD_SDSFP_WRAPPER(128, 32, 10)
#endif  // CONFIG_BLOCK_256_EXT
#if CONFIG_FLEX_PARTITION
...
#endif  // CONFIG_FLEX_PARTITION
#if CONFIG_BLOCK_256_EXT
      HIGHBD_BFP_WRAPPER(64, 256, 12)
      HIGHBD_BFP_WRAPPER(256, 64, 12)
      HIGHBD_BFP_WRAPPER(128, 32, 12)
      HIGHBD_BFP_WRAPPER(32, 128, 12)
#endif  // CONFIG_BLOCK_256_EXT
#if CONFIG_BLOCK_256
...
#if CONFIG_BLOCK_256_EXT
      HIGHBD_MBFP_WRAPPER(64, 256, 12)
      HIGHBD_MBFP_WRAPPER(256, 64, 12)
      HIGHBD_MBFP_WRAPPER(128, 32, 12)
      HIGHBD_MBFP_WRAPPER(32, 128, 12)
#endif  // CONFIG_BLOCK_256_EXT
#if CONFIG_FLEX_PARTITION
...
#if CONFIG_BLOCK_256_EXT
      HIGHBD_OBFP_WRAPPER(256, 64, 12)
      HIGHBD_OBFP_WRAPPER(64, 256, 12)
      HIGHBD_OBFP_WRAPPER(32, 128, 12)
      HIGHBD_OBFP_WRAPPER(128, 32, 12)
#endif  // CONFIG_BLOCK_256_EXT
#if CONFIG_FLEX_PARTITION
...
#if CONFIG_BLOCK_256_EXT
      HIGHBD_SDSFP_WRAPPER(256, 64, 12)
      HIGHBD_SDSFP_WRAPPER(64, 256, 12)
      HIGHBD_SDSFP_WRAPPER(32, 128, 12)
      HIGHBD_SDSFP_WRAPPER(128, 32, 12)
#endif  // CONFIG_BLOCK_256_EXT
#if CONFIG_FLEX_PARTITION
