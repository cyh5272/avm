...
void av1_avg_cdf_symbols(FRAME_CONTEXT *ctx_left, FRAME_CONTEXT *ctx_tr,
  ...
  AVERAGE_CDF(ctx_left->wedge_category_cdf, ctx_tr->wedge_category_cdf, 2);
  AVERAGE_CDF(ctx_left->wedge_idx_cdf, ctx_tr->wedge_idx_cdf, MAX_WEDGE_TYPES);
  AVERAGE_CDF(ctx_left->wedge_idx2_cdf, ctx_tr->wedge_idx2_cdf,
              MAX_WEDGE_TYPES2);
