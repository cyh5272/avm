...
static void aom_accounting_cal_total(AV1Decoder *pbi) {
  if (pbi->decoding_first_frame) {
    ...
    pbi->common.sym_stats.tot_bypass_cycles = 0;
  ...
  int64_t frm_bypass_cycles =
      (accounting.syms.counter_bypass_string
           ? (accounting.syms.cycles_bypass_coded +
              (int)ceil(accounting.syms.counter_bypass_string * BYPASS_WEIGHT))
           : accounting.syms.cycles_bypass_coded);
  ...
  pbi->common.sym_stats.tot_bypass_cycles += frm_bypass_cycles;
  ...
  tot_bypass_cycles = pbi->common.sym_stats.tot_bypass_cycles;
