...
#if CONFIG_BLOCK_256_EXT
VAR_FN_BD12(256, 64, 8, 14);
VAR_FN_BD12(64, 256, 8, 14);
VAR_FN_BD12(32, 128, 8, 12);
VAR_FN_BD12(128, 32, 8, 12);
#endif  // CONFIG_BLOCK_256_EXT
#if CONFIG_FLEX_PARTITION
...
#if CONFIG_BLOCK_256_EXT
HIGHBD_SUBPIX_VAR(256, 64, 14);
HIGHBD_SUBPIX_VAR(64, 256, 14);
HIGHBD_SUBPIX_VAR(32, 128, 12);
HIGHBD_SUBPIX_VAR(128, 32, 12);
#endif  // CONFIG_BLOCK_256_EXT
